<div class="row">
    <div id="pagePanel">
        ...
        <div id="homePanel" <% if $FullWidthPage %>class="fullWidthLayout"<% end_if %>>
            <% if Slides %>
                        ...
                        <li>
                            ...
                            <p class="flex-caption">
                                ...
                                <% if $PageID || $ExternalLink %>
                                    <% if $PageID %>
                                        <a href="$Link"><% with $Page %><span>$Title</span><% end_with %> $Description</a>
                                    <% else %>
                                        <a href="$ExternalLink" target="_blank"><span>$Title $Description</span></a>
                                    <% end_if %>
                                <% else %>
...
<% require css(themes/parish/css/flexslider.css) %>
